...
for opinion in TQDM(ListFolders(pjoin("resources","opinions"), ordered=True), desc='Building opinion modifiers...'):
...
for bop in TQDM(ListFolders(pjoin("resources","bops"), ordered=True), desc='Building bops...'):
