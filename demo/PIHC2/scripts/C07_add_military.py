...
for archetype in TQDM(ListFolders(pjoin("resources","equipments","archetypes"), ordered=True), desc='Building archetypes...'):
...
for tech in TQDM(ListFolders(pjoin("resources","technologies"), ordered=True), desc='Duplicating technologies...'):
...
for tech in TQDM(ListFolders(pjoin("resources","technologies"), ordered=True), desc='Building technologies...'):
    path = pjoin("resources", "technologies", tech)
    AddTechnology(path, translate=False)

# Then add all the doctrines
for tech in TQDM(ListFolders(pjoin("resources","doctrines"), ordered=True), desc='Building doctrines...'):
    path = pjoin("resources", "doctrines", tech)
    AddDoctrine(path, translate=False)
