...
compile_all_jokes()
from scripts.add_random_characters import add_random_characters
add_random_characters()
...
# %%
mods_path = get_config("HOI4_MODS_COMPILE_PATH")
mods_copy_path = get_config("HOI4_MODS_PATH")
