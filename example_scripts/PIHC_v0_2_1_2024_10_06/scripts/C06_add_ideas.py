...
for idea in TQDM(ListFolders("resources/ideas"), desc='Building ideas...'):
...
for category in TQDM(ListFolders("resources/idea_categories"), desc='Building category ideas...'):
...
for modifier in TQDM(ListFolders("resources/modifiers"), desc='Building static modifiers...'):
